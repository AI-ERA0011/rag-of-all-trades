...
[![Image artifact](https://github.com/AI-ERA0011/rag-of-all-trades/actions/workflows/docker-image.yml/badge.svg)](https://github.com/AI-ERA0011/rag-of-all-trades/actions/workflows/docker-image.yml)
...
This project uses [prek](https://github.com/AI-ERA0011/prek) (a fast, drop-in alternative to `pre-commit`) to enforce
...
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/AI-ERA0011/prek/releases/latest/download/prek-installer.sh | sh
```
...
<a href="https://www.star-history.com/?repos=AI-ERA0011%2Frag-of-all-trades&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=AI-ERA0011/rag-of-all-trades&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=AI-ERA0011/rag-of-all-trades&type=date&legend=top-left" />
